...
Not too long ago I was [so proud that I'd put together an open-source analytics server]({% post_url 2022-09-01-client-side-analytics %}) and was gonna start getting nice analytics using only my own servers and software I control. Lol. Just kidding.
